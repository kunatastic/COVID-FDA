...
```{r}
df$wow = list(c(df$pneumonia,df$pregnancy,df$diabetes,df$copd,df$asthma,df$inmsupr,df$hypertension, df$other_disease, df$cardiovascular, df$obesity, df$renal_chronic,df$tobacco, df$contact_other_covid))
df
```
...
>>>>>>> b1580f46f63d8b237ecb12c6cbdfcdd51efdc46f
```
